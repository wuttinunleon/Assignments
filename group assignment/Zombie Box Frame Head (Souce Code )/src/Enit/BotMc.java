...
public class BotMc extends Status {
    Player player;
    BufferedImage skin;
    ...
    public BotMc(GameEngine gameEngine, float x , float y, BufferedImage skin){
        ...
        this.skin=skin;
        randomPlayer();
        animationDown = new Animation(180, Assets.zombieMc_down);
        animationNow = new Animation(180, Assets.zombieMc_down);
        animationUp = new Animation(180, Assets.zombieMc_up);
        animationRight = new Animation(180, Assets.zombieMc_right);
        animationLeft = new Animation(180, Assets.zombieMc_left);
    ...
    public void tick() {
        {
            ...
            if (bothit.equals("Player1") || bothit.equals("Player2")) {
                ...
                if (chh != 2) {
                    if (player.xPosition - xPosition > 0 && (!check(getBoundright())||bothit.equals("Bot"))) {
                    ...
                    if (player.xPosition - xPosition < 0 && ( !check(getBoundleft())||bothit.equals("Bot"))) {
                        xPosition -= movementSpeed;
                    ...
                    if (player.yPosition - yPosition > 0 && ( !check(getBounddown())||bothit.equals("Bot"))) {
                    ...
                    if (player.yPosition - yPosition < 0 && ( !check(getBoundup())||bothit.equals("Bot"))) {
                        yPosition -= movementSpeed;
